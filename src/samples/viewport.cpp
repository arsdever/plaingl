...
void init_scene()
{
    auto basic_mat = assets::asset_manager::get<graphics::material>("standard.standard.mat");
    auto txt = assets::asset_manager::get<graphics::texture>("images.diffuse.png");
    auto norm = assets::asset_manager::get<graphics::texture>("images.brick.png");
